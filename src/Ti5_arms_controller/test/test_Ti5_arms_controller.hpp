...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_TI5_ARMS_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_TI5_ARMS_CONTROLLER_HPP_
...
using ControllerStateMsg = Ti5_arms_controller::Ti5ArmsController::ControllerStateMsg;
using ControllerReferenceMsg = Ti5_arms_controller::Ti5ArmsController::ControllerReferenceMsg;
using ControllerModeSrvType = Ti5_arms_controller::Ti5ArmsController::ControllerModeSrvType;
...
class TestableTi5ArmsController : public Ti5_arms_controller::Ti5ArmsController
{
  FRIEND_TEST(Ti5ArmsControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(Ti5ArmsControllerTest, activate_success);
  FRIEND_TEST(Ti5ArmsControllerTest, reactivate_success);
  FRIEND_TEST(Ti5ArmsControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(Ti5ArmsControllerTest, test_update_logic_fast);
  FRIEND_TEST(Ti5ArmsControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = Ti5_arms_controller::Ti5ArmsController::on_configure(previous_state);
...
class Ti5ArmsControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_Ti5_arms_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_Ti5_arms_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_Ti5_arms_controller")
  {
    ASSERT_EQ(
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_Ti5_arms_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableTi5ArmsController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_TI5_ARMS_CONTROLLER_HPP_
