...
#include "test_Ti5_arms_controller.hpp"

using Ti5_arms_controller::CMD_MY_ITFS;
using Ti5_arms_controller::control_mode_type;
using Ti5_arms_controller::STATE_MY_ITFS;

class Ti5ArmsControllerTest : public Ti5ArmsControllerFixture<TestableTi5ArmsController>
{
};

TEST_F(Ti5ArmsControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, update_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(Ti5ArmsControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(Ti5ArmsControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(Ti5ArmsControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
