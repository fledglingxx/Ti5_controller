...
#include "validate_Ti5_arms_controller_parameters.hpp"
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("Ti5_arms_controller"), prefix) {
    ...
    private:
      ...
      rclcpp::Logger logger_ = rclcpp::get_logger("Ti5_arms_controller");
